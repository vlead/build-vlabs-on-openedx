...
* Introduction
  This documnet contains the process of versioning the vlabs labs
  to github.
* Requirement
...
*** Steps to version control the labs at github 
    ...
    - Clone the lab [[https://github.com/openedx-vlead/vlabs-computer-programming-iiith.git][Computer Programming]].
    - Copy the downloaded lab sources of computer programming lab to
      ...
      /home/sravanthi/vlabs-computer-programming-iiith
      #+END_EXAMPLE
